...
## 写在前面
UnderDark规则适用于剑与魔法的奇幻冒险故事，具有以下特点：
- 基于FATE规则，使用了优秀的形象机制；
- 类似D&D规则，对龙与地下城的机制取其精华去其糟粕；

使用UnderDark规则，可以让玩家和说书人在进行奇幻冒险时，把目光更多地放在角色扮演和故事情节上，而不用关心太多数值细节。
...
### 3.7 本章小结
Fate规则中使用了六个做派，表示六种不同的行事风格，这种设计有一个很大的缺点就是——六个做派是完全“对称”的。对称指的是六个做派除了名字不同，在游戏的机制是完全等价的，这样创建出来的人物在游戏机制上比较千篇一律。

UnderDark规则中使用了D&D规则的六个属性，并尽可能地保留了这些属性在D&D中的用法，同时也兼顾游戏的平衡做出了一些调整，最终让加强不同属性的角色拥有有完全不同的玩法。

## 4 设计特技
这一章会介绍几种特技并给出一些例子作为参考，特技可以看作是对形象的补完或扩展。

### 4.1 种族特技
优雅的精灵，坚毅的矮人，野蛮的兽人，人类以外的种族拥有自己的种族特技。

|种族特技|
|:-|
|森林精灵：森林精灵的感官十分敏锐，在察觉检定中有+2加值。|
|丘陵矮人：丘陵矮人百毒不侵，在对抗毒素的体质防御中有+2加值。|
